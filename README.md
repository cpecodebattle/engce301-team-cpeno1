...
- (อชิตพล) "Elements" เพราะว่าเป็นส่วนที่แก้ไขและตรวจสอบโครงสร้าง HTML และ CSSเพื่อทดสอบและแก้ไขเวลาเว็บแสดงผลผิดตำแหน่งสีเพี้ยนไม่ตามที่ใจต้องการ หรือ layout มีปัญหา
- (ศราวุฒิ) "Console" เพราะเป็นส่วนที่ใช้สำหรับตรวจสอบและดีบักโค้ด JavaScript โดยตรง 
